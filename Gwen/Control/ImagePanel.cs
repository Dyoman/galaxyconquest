...
namespace Gwen.Control
{
    ...
    public class ImagePanel : Base
    {
        ...
        public Bitmap Image
        {
            ...
            set {
                //
                //BitmapData bmpData = value.LockBits(new Rectangle(0,0,value.Width,value.Height), ImageLockMode.ReadOnly, value.PixelFormat);
                //byte[] data = new 
        ...
        public static byte[] ImageToByte(Bitmap img)
        {
            ...
            return (byte[])converter.ConvertTo(img2, typeof(byte[]));
        }
